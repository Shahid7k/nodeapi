...
router.delete("/qa/:quesId",requireSignIn,quesController.isPoster,quesController.deleteQues);

router.put("/qa/:quesId",requireSignIn,quesController.isPoster,quesController.updateQues)
